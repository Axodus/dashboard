...
with c1:
    ...
    trading_pairs = st.text_input("Trading Pairs (separated with commas)", value="BTCUSDT,ETHUSDT")
with c2:
    intervals = st.multiselect("Intervals", options=["1s", "1m", "3m", "5m", "15m", "1h", "4h", "1d"], default=["1m", "3m", "5m", "15m"])
